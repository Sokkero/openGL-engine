...
namespace Engine
{
    ...
    class TransformComponent
    {
        public:
            ...
            glm::vec3 getForward()
            {
                return glm::normalize(glm::vec3(m_modelMatrix[0][2], m_modelMatrix[1][2], m_modelMatrix[2][2]));
            };
            ...
            glm::vec3 getLeft()
            {
                return glm::normalize(glm::vec3(m_modelMatrix[0][0], m_modelMatrix[1][0], m_modelMatrix[2][0]));
            };
